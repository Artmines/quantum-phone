...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('quantum-phone/server/network/get-network-zones', function(Source, Cb)
        Cb(ServerConfig.Networks)
    end)

    CallbackModule.CreateCallback('quantum-phone/server/network/get-nearest-networks', function(Source, Cb, Zone)
    ...
    CallbackModule.CreateCallback('quantum-phone/server/network/connect-to-network', function(Source, Cb, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('quantum-phone/server/vpn/get-vpn-data', function(Source, Cb, HasVPN)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('quantum-phone/server/vpn/set-vpn-data', function(Source, Cb, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
