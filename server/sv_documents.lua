...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('quantum-phone/server/documents/get-by-citizenid', function(Source, Cb)
    ...
    CallbackModule.CreateCallback('quantum-phone/server/documents/new', function(Source, Cb, Data)
        -- Title, type 
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('quantum-phone/server/documents/get-data', function(Source, Cb, Data)
        -- DocumentId
    ...
    CallbackModule.CreateCallback('quantum-phone/server/documents/get-by-type', function(Source, Cb, Data)
        -- Type
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('quantum-phone/server/documents/save', function(Source, Cb, Data)
    ...
    CallbackModule.CreateCallback('quantum-phone/server/documents/delete', function(Source, Cb, Data)
        -- DocumentId
...
RegisterNetEvent("quantum-phone/server/documents/share", function(Data)
    -- DocumentId
    local src = source
    ...
    DatabaseModule.Execute("SELECT * FROM player_phone_documents WHERE id = ?", {Data['DocumentId']}, function(Result)
        if Result[1] ~= nil then
            ...
            for k, v in pairs(Players) do
                ...
                TriggerClientEvent('quantum-phone/client/documents/refresh', TPlayer.PlayerData.Source)
