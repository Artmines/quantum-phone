...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('quantum-phone/server/twitter/get-tweets', function(Source, Cb)
    ...
    EventsModule.RegisterServer("quantum-phone/server/twitter-post", function(Source, Data)
        ...
        DatabaseModule.Insert('INSERT INTO player_phone_tweets (CitizenId, Tweeter, Message, Time, IsBusiness) VALUES (?, ?, ?, ?, ?) ', {
            ...
            if IsSent then
                ...
                TriggerClientEvent('quantum-phone/client/twitter/sync-tweets', -1, Tweet)
