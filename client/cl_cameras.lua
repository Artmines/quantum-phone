...
function Cameras.Render()
    exports['quantum-ui']:SendUIMessage("Phone", "RenderCamerasApp", {
...
RegisterNUICallback("Cameras/AddCamera", function(Data, Cb)
    ...
    local CamData = CallbackModule.SendCallback("quantum-misc/server/gopros/does-exist", Data.CamId)
...
RegisterNUICallback("Cameras/ViewCamera", function(Data, Cb)
    TriggerEvent("quantum-misc/client/gopros/view-camera", Data)
    Cb('Ok')
end)
